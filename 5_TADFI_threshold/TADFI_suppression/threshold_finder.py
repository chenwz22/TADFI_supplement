...
def main():
    ...
    parser.add_argument('-src', '--source', default="megaTOXIN_Drive_TH2.slim", type=str, ##########记得改回来！！！！！！！1
    ...
    parser.add_argument('-Dwt_f_fitness', '--SOMATIC_FITNESS_MUTLIPLIER_F', default=1.0, type=float)
    ...
    if args_dict.pop("print_header", None):
        ...
        print("embryo_cut_rate,germline_cut_rate,Dwt_female_fitness,threshold,capacity,")
