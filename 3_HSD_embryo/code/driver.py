...
def main():
    ...
    parser.add_argument('-src', '--source', default="mega_spatial_2D_homing_dom.slim", type=str,
    ...
    # drive parameters
    parser.add_argument('-conversion', '--DRIVE_CONVERSION', default=0.90, type=float,
                       help='Conversion of drive . Default 1.0.')
    
    parser.add_argument('-embryo_cut_rate', '--EMBRYO_RESISTANCE_CUT_RATE_F_INPUT', default=0.5, type=float,
...
##add columns
    ...
    if args_dict.pop("print_header", None): # 需要和SLiM的输出match,代数=70
        print("radius,fraction,migration,growth,germline,embryo,conversion,fitness,dominantR2,recessiveR2"\
            ...
            "generation,rate_dr,rate_has_drive,rate_r2,ending_pop_size,ending_fertile_female,"\
